...
const regionCenters: Record<string, { x: number; y: number }> = {
  ...
  "region-4": { x: 350, y: 230 }, // Center-left upper (path 4)
  "region-5": { x: 280, y: 120 }, // Top center-left (path 5)
  "region-6": { x: 420, y: 80 }, // Top center (path 6)
  "region-7": { x: 530, y: 140 }, // Top right of center (path 7)
  "region-8": { x: 600, y: 260 }, // Upper center-right (path 8)
  ...
  "region-16": { x: 1300, y: 400 }, // Far east upper (path 16)
